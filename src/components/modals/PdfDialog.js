...
{/*}           <Typography align="center" variant="subtitle1" style={{ color: 'white' }}> */}
    ...
    <Paper className={classes.paperStyle}> 
      ...
      <Typography align="right" variant="subtitle2" style={{paddingRight:50}}>Asunción, 5 de junio del 2022</Typography>
      <Box style={{height: 20}}/>
      ...
      <Typography align="justify" variant="subtitle2">su orden, la suma de guaraníes --- incluir monto en letras---.</Typography>
      <Box style={{height: 10}}/>
      ...
      <Typography align="justify" variant="subtitle2">originará  automáticamente  un  interés  del ____ por  ciento  mensual,  y además de un interés</Typography>
      <Typography align="justify" variant="subtitle2">punitorio del ____ por ciento mensual, sin que ello implique novación.</Typography>
      <Box style={{height: 10}}/>
